...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">EDIT PERAWAT</h3>
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/perawat/{{ $perawat->id }}" method="POST">
                                @method('put')
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_perawat"
                                        ...
                                        is-invalid
                                    @enderror"
                                        id="nama_dokter" value="{{ $perawat->nama_perawat }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="spesialis"
                                        ...
                                        is-invalid
                                    @enderror"
                                        id="spesialis" value="{{ $perawat->spesialis }}">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    is-invalid
                                    @enderror"
                                        name="alamat" rows="10">{{ $perawat->alamat }}</textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    is-invalid
                                    @enderror"
                                        id="no_telp" value="{{ $perawat->no_telp }}">
                                    <div class="invalid-feedback">
